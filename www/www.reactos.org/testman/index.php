 ...
 */
	...
	try
	{
		...
		$facet_compiler = testman_facet_ui_values($dbh, "compiler");
		$facet_vm = testman_facet_ui_values($dbh, "vm");
		$facet_host_os = testman_facet_ui_values($dbh, "host_os");
		$facet_arch = testman_merge_arch_facet_ui($dbh);
	}
	catch (Exception $e)
	{
