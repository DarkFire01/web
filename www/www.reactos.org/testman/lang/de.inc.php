...
*/
	...
	$testman_langres = array(
		...
		"revision" => "Revision",
		"source" => "Quelle",
		"sources" => "Quellen (Builder)",
		"platform" => "Plattform",
		"comment" => "Kommentar",
		"date_from" => "Von Datum/Uhrzeit",
		"date_to" => "Bis Datum/Uhrzeit",
		"search_comment" => "Kommentar enthält",
		"build_number" => "Build-Nummer",
		"filter_compiler" => "Compiler",
		"filter_vm" => "VM / Testumgebung",
		"filter_host_os" => "Host-Betriebssystem",
