...
*/
	...
	$testman_langres = array(
		...
		"revision" => "Rewizja",
		"source" => "Źródło",
		"sources" => "Źródła (buildery)",
		"platform" => "Platforma",
		"comment" => "Komentarz",
		"date_from" => "Od (data/godzina)",
		"date_to" => "Do (data/godzina)",
		"search_comment" => "Komentarz zawiera",
		"build_number" => "Numer kompilacji",
		"filter_compiler" => "Kompilator",
		"filter_vm" => "VM / środowisko testów",
		"filter_host_os" => "System hosta",
		"filter_arch" => "Architektura",
		"nosources" => "Wybierz co najmniej jedno źródło.",
